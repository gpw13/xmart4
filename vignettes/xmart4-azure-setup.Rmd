...
knitr::include_graphics(normalizePath("xmart4-azure-setup_insertimage_2.png"))
```
...
knitr::include_graphics(normalizePath("xmart4-azure-setup_insertimage_3.png"))
```
...
knitr::include_graphics(normalizePath("xmart4-azure-setup_insertimage_4.png"))
```
...
knitr::include_graphics(normalizePath("xmart4-azure-setup_insertimage_5.png"))
```
